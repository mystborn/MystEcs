...
// constructor: A function that is called when a new component is created. Can be NULL.
// destructor: A function that is called when a component is destroyed. Can be NULL.
...
// reference: The entity that already owns the component.
// manager: The component type.
...
// Returns true if both the entity and the component are enabled
bool ecs_component_is_enabled(Entity entity, ComponentManager* manager);

// Gets a component associated with an entity.
// entity: The entity that owns the component.
// manager: The component type.
// component: A pointer that is filled with the component value.
...
// world: The world to get all of the components from.
// manager: The component type.
// count: An int pointer that is filled with the number of components.
// returns an array that holds the components.
...
// Initializes a ComponentIterator for the specified component type.
// world: The world to get the components from.
// manager: The component type.
// iterator: An iterator to initialize.
void ecs_component_iter_enabled_start(EcsWorld world, ComponentManager* manager, ComponentIterator* iterator);

// Moves the ComponentIterator to the next active component, storing the value in result.
// iterator: An iterator to move forward.
// result: A pointer that is filled with the result.
// returns true if the iterator moved forward, or false if there are no more components.
...
// Starts a block that can be used to iterate over all components of the specified type.
// Must close the block with ECS_COMPONENT_ITERATE_ENABLED_END.
// world: The world to get the components from.
// manager: The component type.
// result: A pointer to a pointer of the component type.
