...
ECS_EXPORT void ecs_entity_set_with(EcsEntitySetBuilder* builder, EcsComponentManager* manager) {
    ECS_ARRAY_RESIZE(
...
ECS_EXPORT void ecs_entity_set_without(EcsEntitySetBuilder* builder, EcsComponentManager* manager) {
    ECS_ARRAY_RESIZE(
